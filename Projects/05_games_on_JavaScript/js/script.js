...
function ageInDays() {
 var birthYear = prompt('Твой год рождения?');
 var daysAnswer = (2020 - birthYear) * 365;
 var h1 = document.createElement('h1');
 var textAnswer = document.createTextNode('Дней:' + daysAnswer + '...дальше больше ;)');
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    messageDiv.innerHTML = "<h1 style='color: " + finalMessage['color'] + "; font-size: 46px; padding: 30px;' >" + finalMessage['message'] + "</h1>";
...
// Game 4: Change the color of buttons
...
const hitSound = new Audio('sounds/card_down.mp3');
const winSound = new Audio('sounds/winner.mp3');
const lossSound = new Audio('sounds/loser.mp3');
